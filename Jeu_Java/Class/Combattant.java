public class Combattant extends Personnage{
    public Combattant(){}
    public Combattant(String firstname,String lastname,int lifePoints, int magicPoints, int att, int def,String arme, String armure,String nargue){
        super(firstname,lastname,lifePoints,magicPoints,att,def,arme,armure,nargue);
    }
    @Override
    public String toString(){
        return "Bonjour, les statistiques de ce combattant sont : \n" +
                "Prénom : " + getFirstname() + "\n"+
                "Nom : " + getLastname() + "\n" +
