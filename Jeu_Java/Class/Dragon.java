public class Dragon extends Monstre{
    ...
    public Dragon(String firstname, String lastname, int lifePoints, int att, int def,String Type_elementaire, String capacite_special){
        super(firstname,lastname,lifePoints,att,def,Type_elementaire,capacite_special);
    }

    @Override
    public String toString(){
        return "Bonjour, les statistiques de ce dragon sont : \n" +
                "Prénom : " + getFirstname() + "\n"+
                "Nom : " + getLastname() + "\n" +
