public class Barbare extends Combattant{
    ...
    public Barbare(){}
    public Barbare(String firstname,String lastname,int lifePoints,int magicPoints,int att,int def,String arme,String armure,String nargue){
        super(firstname, lastname, lifePoints, magicPoints, att, def, arme, armure, nargue);
    }

    @Override
    public String toString(){
        return "Bonjour, les statistiques de ce barbare sont : \n" +
                "Prénom : " + getFirstname() + "\n"+
                "Nom : " + getLastname() + "\n" +
